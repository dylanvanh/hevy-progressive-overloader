...
pub async fn handle_workout_completion(
    ...
    tokio::spawn(async move {
        let workout = match state_for_task.hevy_client.get_workout(&workout_id).await {
            Ok(workout) => workout,
            Err(e) => {
        ...
        let routine = match state_for_task
            .hevy_client
        ...
        let response = match state_for_task
        ...
        let exercise_suggestions = state_for_task
            .progressive_overload_service
        ...
        let update_result = state_for_task
            .hevy_client
            .update_routine(
                &workout.routine_id,
